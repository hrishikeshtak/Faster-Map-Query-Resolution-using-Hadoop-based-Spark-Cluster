...
clear
echo "\t\tHadoop 2.2.0 MultiNode Cluster Setup For slave\n"
...
####################################################################################################
echo "\t\tHadoop 2.2.0 MultiNode Cluster Setup\n"
...
sudo -u hduser sed -i '1islave01' /usr/local/hadoop/etc/hadoop/slaves
